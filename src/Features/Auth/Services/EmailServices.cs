...
namespace HUBTSOCIAL.src.Features.Auth.Services
{
    public class EmailService : IEmailService
    {
        ...
        public EmailService()
        {
            ...
            var smtpUsername = Environment.GetEnvironmentVariable("SMTP_USERNAME") ?? "bachaidang19082004@gmail.com";
            var smtpPassword = Environment.GetEnvironmentVariable("SMTP_PASSWORD") ?? "ffhe zjzf ybfe lovb";
